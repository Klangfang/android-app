 ...
 */
public class SaveSoundActivity extends BaseActivity implements FragmentObserver
{
    private final static String TAG = SaveSoundActivity.class.getSimpleName();

    public final static String EXTRA_SOUND_FILE_URI = "extra-sound-file-uri";

    @BindView(R.id.plv_sounds_player)
    PlayerLargeView soundsPlayerView;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        rlHashtags.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragment.setObserver(SaveSoundActivity.this);
    ...
    private void initSoundsPlayerView()
    {
        if(getIntent().hasExtra(EXTRA_SOUND_FILE_URI))
        {
            String fileUri = getIntent().getStringExtra(EXTRA_SOUND_FILE_URI);
            soundsPlayerView.play(fileUri);
        }
    }
/*
